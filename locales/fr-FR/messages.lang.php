...
$GLOBALS['__l10n']["%1s', get_data('label"]="%1s', get_data('label";
...
$GLOBALS['__l10n']["%s test-taker(s) are excluded.', get_data('ttexcluded"]="%s participants sont exclus.', get_data('ttexcluded";
...
$GLOBALS['__l10n']["An error occured during the import"]="Une erreur s'est produite au cours de l'importation.";
...
$GLOBALS['__l10n']["Assembly"]="Assemblée";
$GLOBALS['__l10n']["Assembly import"]="Import de l'assemblée";
...
$GLOBALS['__l10n']["Assigned Tests"]="Tests assignés";
$GLOBALS['__l10n']["Assigned to"]="Assigné à ";
$GLOBALS['__l10n']["Attempt(s)"]="Tentative(s)";
...
$GLOBALS['__l10n']["Completed Tests"]="Tests terminés";
...
$GLOBALS['__l10n']["Create a test"]="Créer un test";
...
$GLOBALS['__l10n']["Delivery is assigned to %s test-takers.', get_data('ttassigned"]="La livraison est assignée à %s participants.', get_data('ttassigned";
$GLOBALS['__l10n']["Delivery is not assigned to any test-taker."]="La passation n'est pas assignée à un participant.";
...
$GLOBALS['__l10n']["Element"]="Élément";
$GLOBALS['__l10n']["Enables you to export a published delivery"]="Vous autorise à exporter une passation publiée";
...
$GLOBALS['__l10n']["Export Options"]="Exporter les options";
...
$GLOBALS['__l10n']["Manifest not found in assembly"]="Manifeste non trouvé dans l'assemblée";
...
$GLOBALS['__l10n']["My Tests"]="Mes tests";
...
$GLOBALS['__l10n']["No attempt has been started yet."]="Aucune tentative n'a déjà commencé.";
$GLOBALS['__l10n']["No extensions available."]="Pas d'extension disponible.";
$GLOBALS['__l10n']["no file"]="pas de fichier";
$GLOBALS['__l10n']["No information available"]="Aucune information disponible";
...
$GLOBALS['__l10n']["Paused Tests"]="Tests en attente";
...
$GLOBALS['__l10n']["Please upload a published delivery assembly ."]="Veuillez télécharger une assemblée de passations publiées.";
...
$GLOBALS['__l10n']["Published on %2s', tao_helpers_Date::displayeDate(get_data('date"]="Publié sur %2s', tao_helpers_Date::displayeDate(get_data('date";
...
$GLOBALS['__l10n']["Resume"]="Continuer";
...
$GLOBALS['__l10n']["Select the test you want to publish to the test-takers"]="Sélectionner le test à publier pour les participants";
...
$GLOBALS['__l10n']["Status saved"]="État enregistré";
...
$GLOBALS['__l10n']["TAO - An Open and Versatile Computer-Based Assessment Platform"]="TAO – Une plate-forme d'évaluation des compétences ouverte et polyvalente";
...
$GLOBALS['__l10n']["There are currently %s attempts', get_data('exec"]="Il y a actuellement %s tentatives', get_data('exec";
$GLOBALS['__l10n']["There are currently no tests available to publish."]="Il n'y a actuellement aucun test disponible pour publication.";
$GLOBALS['__l10n']["There is currently 1 attempt"]="Il y a actuellement une tentative.";
...
$GLOBALS['__l10n']["Unkown error during impoort"]="Erreur inconnue au cours de l'importation";
$GLOBALS['__l10n']["Unlimited"]="Illimité";
$GLOBALS['__l10n']["Upload"]="Téléverser";
$GLOBALS['__l10n']["Upload a new content"]="Téléverser un nouveau contenu";
$GLOBALS['__l10n']["Upload an assembly"]="Télécharger une assemblée";
